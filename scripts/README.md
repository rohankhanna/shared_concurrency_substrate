...
- `sudo_allow.py`: constrained sudo wrapper for NFS mount/umount (see `docs/SUDO_WRAPPER.md`).
- `sudo_allowlist.sample.json`: sample allowlist config for the sudo wrapper.
