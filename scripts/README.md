...
- `terminal_sudo_guard.py`: constrained sudo wrapper for NFS mount/umount (see `docs/SUDO_WRAPPER.md`).
- `terminal_sudo_guard_allowlist.sample.json`: sample allowlist config for the sudo wrapper.
